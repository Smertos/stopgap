...
- **Biggest missing pieces:** runtime-wrapper duplication reduction, operational hardening (memory caps/runtime constraints/metrics/GUC tuning), CLI implementation, and docs roadmap items.
