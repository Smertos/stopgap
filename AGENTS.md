...
- When `stopgap.deploy_exports` metadata is provided, stopgap deploy must fail fast on drift by rejecting missing, unknown, or duplicate export entries relative to deployable functions.
