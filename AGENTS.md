...
- Runtime performance baseline timing uses nanosecond totals (converted to per-call milliseconds) to avoid millisecond-quantization flakes in CI measurable-time assertions.
