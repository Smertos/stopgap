...
- Shared helper migration has started via `crates/common` (SQL quoting + bool-setting parsing); pg_test suites now live in `crates/*/tests/pg/`, while broader module split and test-file granularity extraction remain pending.
